...
import { CheckCircle2, Calendar, Clock, GraduationCap } from "lucide-react"
import Link from "next/link"
import { format } from "date-fns"

export default async function ClassConfirmationPage({
  params,
}: {
        ...
        <div className="max-w-2xl mx-auto">
          <Card className="bg-zinc-900 border-zinc-800">
            <CardHeader className="text-center pb-8">
              ...
              <CardTitle className="text-white text-3xl mb-2">Lesson Confirmed!</CardTitle>
              <CardDescription className="text-zinc-400 text-lg">
                Your payment has been received and your lesson is confirmed
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="bg-zinc-950 p-6 rounded-lg border border-zinc-800 space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white font-semibold text-lg">{booking.private_classes.instructor_name}</p>
                    <p className="text-zinc-400 text-sm">{booking.private_classes.instrument}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400 text-sm">{booking.private_classes.duration_minutes} minutes</p>
                  </div>
                </div>
              ...
              <div className="bg-orange-950/30 border border-orange-900/50 p-4 rounded-lg">
                ...
                <ul className="text-zinc-300 text-sm space-y-1 leading-relaxed">
                  <li>• Please arrive 5 minutes before your lesson</li>
                  <li>• Bring your instrument if required</li>
                  <li>• Bring any music books or materials you want to work on</li>
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-4">
                ...
                <Link href="/classes" className="flex-1">
                  <Button className="w-full bg-orange-600 hover:bg-orange-700 text-white">Browse More Classes</Button>
                </Link>
              </div>
            </CardContent>
          </Card>
